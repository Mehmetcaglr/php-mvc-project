<div class="card-footer">
    <div class="btn-group">
        ...
        <div class="dropdown-menu dropdown-menu-right m-r-0-minus w-100">
            <a href="<?php echo "writer?limit=2"; ?>" class="dropdown-item">2</a>
            <div class="dropdown-divider"></div>
            <a href="<?php echo "writer?limit=5"; ?>" class="dropdown-item">5</a>
            <div class="dropdown-divider"></div>
            <a href="<?php echo "writer?limit=10" ?>" class="dropdown-item">10</a>
            <div class="dropdown-divider"></div>
            <a href="<?php echo "writer?limit=15"; ?>" class="dropdown-item">15</a>
            <div class="dropdown-divider"></div>
            <a href="<?php echo "writer?limit=50"; ?>" class="dropdown-item">50</a>
            <div class="dropdown-divider"></div>
            <a href="<?php echo "writer?limit=100"; ?>" class="dropdown-item">100</a>
            <div class="dropdown-divider"></div>
            <a href="<?php echo "writer?limit=500"; ?>" class="dropdown-item">500</a>
        </div>
    </div>

    <?php  pagination($data["writer"]["links"],"writer"); ?>
